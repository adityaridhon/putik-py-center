    ...
    public function run(): void
    {
        $categories = [
            ...
            [
                ...
                'instruction' => 'Hafalkan kata pada gambar selama 3 menit. Setelah itu tuliskan kata yang Anda ingat selama 6 menit.',
                'order' => 9,
                'questions' => [
                    ['question_text' => 'BUNGA', 'correct_answer' => 'BUNGA'],
                    ['question_text' => 'PERKAKAS', 'correct_answer' => 'PERKAKAS'],
                    ['question_text' => 'BURUNG', 'correct_answer' => 'BURUNG'],
                    ['question_text' => 'JENDELA', 'correct_answer' => 'JENDELA'],
                    ['question_text' => 'KAPAL', 'correct_answer' => 'KAPAL'],
                    ['question_text' => 'LILIN', 'correct_answer' => 'LILIN'],
                    ['question_text' => 'KERTAS', 'correct_answer' => 'KERTAS'],
                    ['question_text' => 'JAMUR', 'correct_answer' => 'JAMUR'],
                    ['question_text' => 'PENSIL', 'correct_answer' => 'PENSIL'],
                ],
            ],
        ];
